...
Computer chips are tiny. A current generation CPU (Ryzen 9000) uses a mind-blowing 4nm FinFET architecture (this does not mean each transistor gate is 4nm wide)! Without the invention of an electron microscope, viewing these tiny chips during development is impossible. 
